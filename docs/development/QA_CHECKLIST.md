...
## v53.3 Play Tab Access Checks

- [ ] Student Mode Core preset shows Schedule, Add, Talk, Help, Calm, and Play.
- [ ] Play opens the StudentGamesPanel.
- [ ] Choice Wheel still spins and supports custom labels.
- [ ] Staff Students tab shows Core: Schedule, Add, Talk, Help, Calm, Play.
- [ ] Staff Settings and Staff Auth Gate still work.
- [ ] VERSION_FEATURES.md contains v53.3.
- [ ] Build succeeds on Render.


## v54 File Structure Checks

- [ ] `src/components` has no flat `.jsx` files.
- [ ] `src/components/app` exists.
- [ ] `src/components/shared` exists.
- [ ] `src/components/student` exists with schedule, communication, support, profile, and games folders.
- [ ] `src/components/staff` exists with dashboard, setup, students, choices, schedule, notes, reports, and settings folders.
- [ ] Student Mode opens.
- [ ] Staff Mode opens after sign-in.
- [ ] Play tab opens.
- [ ] Add-to-schedule flow still works.
- [ ] Build succeeds on Render.

## v55 Documentation Structure Checks

- [ ] Root has only `README.md` as a markdown file.
